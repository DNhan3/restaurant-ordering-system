...
import { Receipt, ChevronDown, ChevronUp, MapPin, Phone, Clock, XCircle, Check } from 'lucide-react';
            ...
            return (
              <div key={bill.bill_id} className="bg-white rounded-2xl shadow-md overflow-hidden">
                <div
                  ...
                  onClick={() => onToggleBillDetails(bill)}
                >
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      {canCancelBill(bill.bill_status) && (
                        <button
                          type="button"
                          onClick={(event) => onCancelBill(event, bill)}
                              ...
                              <div className="w-16 h-16 rounded-lg overflow-hidden bg-brown-100 flex-shrink-0">
                                {item.food?.food_image ? (
                                  <img
                                    ...
                                    onError={(event) => {
                                      event.target.src = 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=100&h=100&fit=crop';
                                    }}
                                  />
                                ) : (
